            ...
            <div className="min-w-0 flex-1">
              ...
              {hasGuides && (
                <p className="text-muted-foreground text-xs">
                  {t('{{count}} guide images on this level', { count: guides.length })}
                </p>
              )}
            </div>
                  ...
                  <div className="flex min-w-0 items-center gap-2">
                    ...
                    >
                      ...
                      <p className="truncate font-medium text-foreground text-sm">
                        {guide.name || t('Guide image {{number}}', { number: index + 1 })}
                      </p>
                      {selectedReferenceId === guide.id && (
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0 flex-1">
              ...
              {hasScans && (
                <p className="text-muted-foreground text-xs">
                  {t('{{count}} scans on this level', { count: scans.length })}
                </p>
              )}
            </div>
            <UploadButton onError={setUploadError} />
                ...
                >
                  <div className="flex min-w-0 items-center gap-2">
                    ...
                    >
                      ...
                      />
                      <p className="truncate font-medium text-foreground text-sm">
                        {scan.name || t('Scan {{number}}', { number: index + 1 })}
                      </p>
                      {selectedReferenceId === scan.id && (
                        <Check className="ml-auto h-3.5 w-3.5 shrink-0 text-foreground/80" />
                      )}
    ...
    <Popover onOpenChange={setIsOpen} open={isOpen}>
      <div className="flex items-center">
        <ActionButton
          ...
          label={`${t('References')}: ${anyVisible ? t('Visible') : t('Hidden')}`}
          onClick={toggleAll}
          size="icon"
          variant="ghost"
        >
      ...
      >
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <button
              aria-label={showReferenceFloor ? t('Hide reference floor') : t('Show reference floor')}
