            ...
            >
              {levels.map((level) => (
                <option key={level.id} value={level.id}>
                  {level.name || t('Level {{count}}', { count: level.level + 1 })}
                </option>
              ))}
            </select>
          </div>
            ...
            {segments.map((seg, i) => (
              ...
              >
                <span className="truncate">
                  {seg.name || t('Segment {{count}}', { count: i + 1 })}
                </span>
