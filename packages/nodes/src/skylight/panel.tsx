            ...
            return (
              ...
              >
                <span className="min-w-0 truncate font-medium">
                  {t(SKYLIGHT_TYPE_PRESETS[skylightType].label)}
                </span>
              </button>
            )
          })}
        ...
        {activeSkylightType === 'opening' && (
          <>
            ...
            <SegmentedControl
              ...
              options={[
                { label: t('Motor'), value: 'yes' },
                { label: t('No Motor'), value: 'no' },
              ]}
              value={(node.motorHousing ?? false) ? 'yes' : 'no'}
            />
            {(node.motorHousing ?? false) && (
              <SliderControl
                label={t('Motor Housing')}
                max={0.2}
                min={0.03}
        ...
        {activeSkylightType === 'sliding' && (
          <>
            ...
            <SegmentedControl
              ...
              options={[
                { label: t('Along Z'), value: 'z' },
                { label: t('Along X'), value: 'x' },
              ]}
